...
| 9 | 1:58–2:14 | Survey beat. Console calls `survey_unit` three times in a row, no click; the rail fills with rows labelled unconfirmed: NE tip storey 12, SE core storey 30, SW tip storey 44. | "Three units surveyed. No click. Every number unconfirmed." | Ask about three units and it surveys them in a row, no click needed, every number labelled unconfirmed. The report belongs to the one you confirm. |
