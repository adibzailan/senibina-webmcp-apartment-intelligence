...
- Coda: paper card "How this was made."; the founder's own desk recording (`footage/founder/desk-take-1.mov`, from 40 s) in the presentation frame with the argument in the left column; the close card "Apartment Intelligence, built for the OpenAI WebMCP Challenge." with the URL. Narration `footage/audio/beats/b13-coda.mp3` (second take, naming the wrist injury and Codex; the first take is kept as `b13-coda-v1-no-cause.mp3`), ElevenLabs clone "Adib", `eleven_v3`, one generation, subtitled phrase by phrase from silence detection. Music: the unused tail of the same v1 track from 2:03, at 0.11, four-second fade.
