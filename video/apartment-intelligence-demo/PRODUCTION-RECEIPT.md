...
- Master: `renders/apartment-intelligence-demo-v2-coda.mp4`, 2:57, 1920 × 1080, 30 fps, H.264 + AAC 48 kHz. Measured -16.2 LUFS integrated, -1.2 dBTP. Built by `build-coda.py`: the fast cut (rebuilt 4 September with the sales lines in quotation marks) for 2:03, then a hard cut into a 39 s coda.
